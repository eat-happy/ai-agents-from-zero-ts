...
| `PydanticDemo.ts`          | 先单独理解 Pydantic 校验与转换        | 再看         |
...
【案例源码】`cases-langchain/08-tools/PydanticDemo.ts`

[PydanticDemo.py](cases-langchain/08-tools/PydanticDemo.ts ":include :type=code")
