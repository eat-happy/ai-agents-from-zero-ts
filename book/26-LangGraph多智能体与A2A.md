...
- **数据分析代理团队**：数据理解 Agent 解释指标口径，SQL / TypeScript Agent 查询和计算，图表 Agent 生成可视化，业务解释 Agent 输出结论和建议。
...
【案例源码】`案例与源码-3-LangGraph框架/08-multi_agent/LangGraphAgent.ts`

[LangGraphAgent.ts](案例与源码-3-LangGraph框架/08-multi_agent/LangGraphAgent.ts ":include :type=code")
...
【案例源码】`案例与源码-3-LangGraph框架/08-multi_agent/SupervisorV0.3.ts`

[SupervisorV0.3.ts](案例与源码-3-LangGraph框架/08-multi_agent/SupervisorV0.3.ts ":include :type=code")
...
如果你对照第 21 章 Agent 和第 22~25 章 LangGraph 主线来看，这个案例还有一个教学价值：它让你看到 **`createReactAgent` 创建的 Agent 完全可以继续被放进更大的 LangGraph 多智能体结构里**。换句话说，单 Agent 不是多智能体的对立面，而是多智能体系统里的基础部件。

【案例源码】`案例与源码-3-LangGraph框架/08-multi_agent/SupervisorV1.0.ts`

[SupervisorV1.0.ts](案例与源码-3-LangGraph框架/08-multi_agent/SupervisorV1.0.ts ":include :type=code")
...
【案例源码】`案例与源码-3-LangGraph框架/08-multi_agent/SupervisorHandoff.ts`

[SupervisorHandoff.ts](案例与源码-3-LangGraph框架/08-multi_agent/SupervisorHandoff.ts ":include :type=code")
