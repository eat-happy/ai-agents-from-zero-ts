 ...
 * Source: cases-langgraph/03-state/reducers/StateReducer_Custom.py
...
def MyOperatorMul(current: number, update: number) -> float:
...
function run_demo() {
    console.log("使用自定义reducer解决乘法问题:")
