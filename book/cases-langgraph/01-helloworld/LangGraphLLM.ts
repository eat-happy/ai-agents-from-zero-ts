 ...
 * Source: cases-langgraph/01-helloworld/LangGraphLLM.py
...
- 模型初始化沿用第 10 章“调用三件套”思维：模型名、API Key、Base URL。本文件保留 apiKey:process.env.aliQwen-api 写法不改动。
...
import { BaseMessage, HumanMessage, message_to_dict } from "@langchain/core/messages"
...
function model_node(state: DiliState) {
...
console.log("模型回答：", result["messages"][-1].content)
