...
【案例源码】`cases-langchain/02-models_io/ModelIO_Params.ts`

[ModelIO_Params.py](cases-langchain/02-models_io/ModelIO_Params.ts ":include :type=code")
...
console.log(type(model))             // 模型客户端对象
console.log(type(response))          // AIMessage
console.log(type(response.content))  // str
...
【案例源码】`cases-langchain/02-models_io/ModelIO_OpenAI.ts`

[ModelIO_OpenAI.py](cases-langchain/02-models_io/ModelIO_OpenAI.ts ":include :type=code")
...
【案例源码】`cases-langchain/02-models_io/ModelIO_ChatOpenAI.ts`

[ModelIO_ChatOpenAI.py](cases-langchain/02-models_io/ModelIO_ChatOpenAI.ts ":include :type=code")
...
【案例源码】`cases-langchain/02-models_io/ModelIO_Init_chat_model.ts`

[ModelIO_Init_chat_model.py](cases-langchain/02-models_io/ModelIO_Init_chat_model.ts ":include :type=code")
...
【案例源码】`cases-langchain/02-models_io/ModelIO_DeepSeek.ts`

[ModelIO_DeepSeek.py](cases-langchain/02-models_io/ModelIO_DeepSeek.ts ":include :type=code")
...
console.log(model.invoke("你是谁？").content)
...
【案例源码】`cases-langchain/02-models_io/ModelIO_Qwen.ts`

[ModelIO_Qwen.py](cases-langchain/02-models_io/ModelIO_Qwen.ts ":include :type=code")
...
// [TS-PORT] Auto-migrated from Python example for TypeScript track. Prefer examples/ and POLISHED-CASES when APIs differ.
import { ChatOpenAI } from "@langchain/openai";
configurable_model = new new ChatOpenAI(temperature:0)
