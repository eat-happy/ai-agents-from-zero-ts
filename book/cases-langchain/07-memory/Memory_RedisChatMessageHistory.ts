 ...
 * Source: cases-langchain/07-memory/Memory_RedisChatMessageHistory.py
 * Prefer the curated runnable examples under /examples when APIs differ.
 */

// [TS-PORT] 由原 Python 示例自动迁移，建议对照 examples/ 目录可运行版本精读
/* 
【案例】Redis 持久化对话历史：/* message history wrapper */ + RedisChatMessageHistory
...
- /* message history wrapper */ 负责“什么时候读写历史”，RedisChatMessageHistory 负责“历史存到哪里”；两者是配合关系，不是替代关系。
