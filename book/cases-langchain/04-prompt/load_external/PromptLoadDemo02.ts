 ...
 * Source: cases-langchain/04-prompt/load_external/PromptLoadDemo02.py
...
warnings.filterwarnings(
    "ignore", message="Core Zod V1 functionality isn't compatible with Python 3.14"
)
...
console.log(template.format(name="年轻人", what="滑稽"))
#
