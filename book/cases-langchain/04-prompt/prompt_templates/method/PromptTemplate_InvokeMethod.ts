 ...
 * Source: cases-langchain/04-prompt/prompt_templates/method/PromptTemplate_InvokeMethod.py
...
console.log(prompt.to_string())
console.log(type(prompt.to_string()))
print()

// ---------- 4. to_messages()：转成「消息列表」，可接入需要多角色消息的链 ----------
console.log(prompt.to_messages())
console.log(type(prompt.to_messages()))
