 ...
 * Source: cases-langchain/04-prompt/prompt_templates/PromptTemplate_PartialVariables.py
...
console.log(template3.format(foo="li4", bar="world"))  // li4 world
console.log(template3.format(bar="world"))  // hello world
