 ...
 * Source: cases-langchain/05_parser/StrOutputParserDemo.py
...
content='LangChain 是一个开源框架，用于构建基于大语言模型（LLM）的应用程序。它提供模块化组件（如链、代理、记忆、工具等），支持提示工程、数据检索增强（RAG）、多步推理和外部工具调用，简化 LLM 应用的开发与集成。' additional_kwargs={'refusal': null} response_metadata={'token_usage': {'completion_tokens': 67, 'prompt_tokens': 38, 'total_tokens': 105, 'completion_tokens_details': null, 'prompt_tokens_details': {'audio_tokens': null, 'cached_tokens': 0}}, 'model_provider': 'openai', 'model_name': 'qwen-plus', 'system_fingerprint': null, 'id': 'chatcmpl-7f8b2cc0-7b6a-98c7-8180-4d8fe4433fd3', 'finish_reason': 'stop', 'logprobs': null} id='lc_run--019c9dcc-cdc5-71d3-9b0e-8ca64d9ae28d-0' tool_calls=[] invalid_tool_calls=[] usage_metadata={'input_tokens': 38, 'output_tokens': 67, 'total_tokens': 105, 'input_token_details': {'cache_read': 0}, 'output_token_details': {}}
