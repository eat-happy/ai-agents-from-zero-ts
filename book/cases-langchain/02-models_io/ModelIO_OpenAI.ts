 ...
 * Source: cases-langchain/02-models_io/ModelIO_OpenAI.py
...
client = OpenAI(
    apiKey:process.env.deepseek-api,  // 从环境变量读取，此处以 DeepSeek 为例
    configuration: { baseURL:"https://api.deepseek.com",  // 可改为其他 OpenAI 兼容地址（如阿里百炼）
)
