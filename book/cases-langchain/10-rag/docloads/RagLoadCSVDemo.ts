 ...
 * Source: cases-langchain/10-rag/docloads/RagLoadCSVDemo.py
...
// npm install langchain_community
...
console.log("=== 方式一：整行作为 page_content ===")
print(
    "page_content 示例:",
    (
...
console.log("metadata 示例:", docs_all[0].metadata, "\n")
...
console.log("=== 方式二：content 列作为正文，title/author 进 metadata ===")
console.log("page_content 示例:", docs_split[0].page_content)
console.log("metadata 示例:", docs_split[0].metadata)
