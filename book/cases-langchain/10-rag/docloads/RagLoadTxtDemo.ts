 ...
 * Source: cases-langchain/10-rag/docloads/RagLoadTxtDemo.py
...
- TextLoader 用于纯文本（.txt），需指定文件路径和编码（如 utf-8）；load() 返回 Document[]，多行文本通常合并为一个 Document。
...
// load() 为 BaseLoader 统一接口，返回 Document[]
