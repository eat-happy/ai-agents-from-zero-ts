 ...
 * Source: cases-langchain/09-embedding/Text2Embedding_DashScopePro.py
...
dashscope.apiKey: process.env.aliQwen-api
...
if (resp.status_code == HTTPStatus.OK) {
    ...
    console.log(json.dumps(result, ensure_ascii=false, indent=4))
...
console.log(json.dumps(embedding_values, ensure_ascii=false))
