 ...
 * Source: cases-langchain/09-embedding/Text2Embedding_DashScope.py
...
// npm install langchain-community dashscope
import os
...
embeddings = DashScopeEmbeddings(
    ...
    dashscope_apiKey:process.env.aliQwen-api,
)
...
console.log("文本向量长度：", len(query_result), sep="")
