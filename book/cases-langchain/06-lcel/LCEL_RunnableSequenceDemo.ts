 ...
 * Source: cases-langchain/06-lcel/LCEL_RunnableSequenceDemo.py
...
logger.info(`Chain执行结果:\n{result_chain}`)
logger.info(`Chain执行结果类型: {type(result_chain)}`)
...
content='LangChain 是一个开源框架，用于构建基于大语言模型（LLM）的应用程序。它提供模块化组件（如链、代理、记忆、工具等），支持提示工程、外部数据接入、多步推理与状态管理，简化 LLM 应用的开发与集成。' additional_kwargs={'refusal': null} response_metadata={'token_usage': {'completion_tokens': 62, 'prompt_tokens': 38, 'total_tokens': 100, 'completion_tokens_details': null, 'prompt_tokens_details': {'audio_tokens': null, 'cached_tokens': 0}}, 'model_provider': 'openai', 'model_name': 'qwen-plus', 'system_fingerprint': null, 'id': 'chatcmpl-45f313fd-c388-9498-baa4-c9036e7644a1', 'finish_reason': 'stop', 'logprobs': null} id='lc_run--019cc0e8-5f78-7ef3-a751-d1a4bcfba176-0' tool_calls=[] invalid_tool_calls=[] usage_metadata={'input_tokens': 38, 'output_tokens': 62, 'total_tokens': 100, 'input_token_details': {'cache_read': 0}, 'output_token_details': {}}
