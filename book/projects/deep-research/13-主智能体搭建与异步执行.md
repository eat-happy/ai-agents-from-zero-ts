...
在项目根目录，执行：`uv run npx tsx app.tools.upload_file_read_tool`
...
在项目根目录，执行：`uv run npx tsx app.tools.markdown_tools`
...
在项目根目录，执行：`uv run npx tsx app.tools.pdf_tools`
...
在项目根目录下执行：`uv run npx tsx app.agent.main_agent`
