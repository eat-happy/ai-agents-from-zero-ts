...
| 本章用法                  | 对应仓库案例                                                               |
| ------------------------- | -------------------------------------------------------------------------- |
| `messages + add_messages` | `cases-langgraph/03-state/reducers/StateReducer_AddMessages.ts` |
| 条件边                    | `cases-langgraph/05-edge/Edge_Conditional.ts`                   |
| 多节点业务流              | `cases-langgraph/01-helloworld/LangGraphBiz.ts`                 |
...
```text
tools@ToolsMacBook-Pro deepsearch-agents % uv run examples/6-langgraph-subagent-wrapper.ts
...
```text
tools@ToolsMacBook-Pro deepsearch-agents % uv run examples/7-langchain-agent-subagent-wrapper.ts
