...
def load_prompt(name: str) -> str:
    ...
    # app/prompt/prompt_loader.ts 向上两级回到项目根目录，再进入 prompts 目录
...
项目对应文件路径：`shopkeeper-agent/app/agent/nodes/recall_column.ts`
...
项目对应文件路径：`shopkeeper-agent/app/agent/nodes/recall_metric.ts`
...
指标实体对应文件：`shopkeeper-agent/app/entities/metric_info.ts`
...
项目对应文件路径：`shopkeeper-agent/app/agent/nodes/recall_value.ts`
...
字段取值实体对应文件：`shopkeeper-agent/app/entities/value_info.ts`
