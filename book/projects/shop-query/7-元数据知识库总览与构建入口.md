...
Traceback (most recent call last):
  File ".../app/scripts/build_meta_knowledge.py", line 8, in <module>
    // logger from your app logger module
...
在包结构项目里，更推荐的做法是：**在项目根目录下，用 `npx tsx` 执行包内模块。**
...
- 推荐在后端项目根目录下，使用 `uv run npx tsx app.scripts.build_meta_knowledge -c conf/meta_config.yaml` 执行脚本
