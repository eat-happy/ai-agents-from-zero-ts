...
【案例源码】`案例与源码-2-LangChain框架/04-prompt/invoke/LLM_Invoke_InputTypes.ts`

[LLM_Invoke_InputTypes.ts](案例与源码-2-LangChain框架/04-prompt/invoke/LLM_Invoke_InputTypes.ts ":include :type=code")
...
“System / User / Assistant / Tool” 这套思路并不是 LangChain TypeScript 独有的，Java 生态中的 **LangChain4J**、**Spring AI** 也有类似设计。理解这一点很有价值，因为它说明：
...
【案例源码】`案例与源码-2-LangChain框架/04-prompt/invoke/LLM_Invoke.ts`、`LLM_aInvoke.ts`
...
[LLM_Invoke.ts](案例与源码-2-LangChain框架/04-prompt/invoke/LLM_Invoke.ts ":include :type=code")

[LLM_aInvoke.ts](案例与源码-2-LangChain框架/04-prompt/invoke/LLM_aInvoke.ts ":include :type=code")

### 4.2 流式调用（stream / astream）

【案例源码】`案例与源码-2-LangChain框架/04-prompt/invoke/LLM_Stream.ts`、`LLM_aStream.ts`
...
[LLM_Stream.ts](案例与源码-2-LangChain框架/04-prompt/invoke/LLM_Stream.ts ":include :type=code")

[LLM_aStream.ts](案例与源码-2-LangChain框架/04-prompt/invoke/LLM_aStream.ts ":include :type=code")

### 4.3 批处理（batch / abatch）

【案例源码】`案例与源码-2-LangChain框架/04-prompt/invoke/LLM_Batch.ts`、`LLM_aBatch.ts`
...
[LLM_Batch.ts](案例与源码-2-LangChain框架/04-prompt/invoke/LLM_Batch.ts ":include :type=code")

[LLM_aBatch.ts](案例与源码-2-LangChain框架/04-prompt/invoke/LLM_aBatch.ts ":include :type=code")
...
- 系统角色长期固定为“TypeScript / Node 工程师”
- 但用户问题每次都不同

这样一来，你就不用每次都重复传 `role="TypeScript / Node 工程师"`。
...
【案例源码】  
format：`案例与源码-2-LangChain框架/04-prompt/prompt_templates/method/PromptTemplate_FormatMethod.ts`  
invoke：`案例与源码-2-LangChain框架/04-prompt/prompt_templates/method/PromptTemplate_InvokeMethod.ts`  
partial：`案例与源码-2-LangChain框架/04-prompt/prompt_templates/method/PromptTemplate_PartialMethod.ts`

[PromptTemplate_FormatMethod.ts](案例与源码-2-LangChain框架/04-prompt/prompt_templates/method/PromptTemplate_FormatMethod.ts ":include :type=code")

[PromptTemplate_InvokeMethod.ts](案例与源码-2-LangChain框架/04-prompt/prompt_templates/method/PromptTemplate_InvokeMethod.ts ":include :type=code")

[PromptTemplate_PartialMethod.ts](案例与源码-2-LangChain框架/04-prompt/prompt_templates/method/PromptTemplate_PartialMethod.ts ":include :type=code")
...
【案例源码】构造函数：`案例与源码-2-LangChain框架/04-prompt/prompt_templates/PromptTemplate_Constructor.ts`  
【案例源码】`from_template`：`案例与源码-2-LangChain框架/04-prompt/prompt_templates/PromptTemplate_FromTemplate.ts`

[PromptTemplate_Constructor.ts](案例与源码-2-LangChain框架/04-prompt/prompt_templates/PromptTemplate_Constructor.ts ":include :type=code")

[PromptTemplate_FromTemplate.ts](案例与源码-2-LangChain框架/04-prompt/prompt_templates/PromptTemplate_FromTemplate.ts ":include :type=code")
...
[PromptTemplate_Combined.ts](案例与源码-2-LangChain框架/04-prompt/prompt_templates/PromptTemplate_Combined.ts ":include :type=code")

**第二，比较 `partial_variables` 与 `partial()`。**  
二者都能做到“先固定一部分变量，后续只传剩余变量”，但一个发生在模板创建阶段，一个发生在已有模板基础上。

[PromptTemplate_PartialVariables.ts](案例与源码-2-LangChain框架/04-prompt/prompt_templates/PromptTemplate_PartialVariables.ts ":include :type=code")
...
【案例源码】  
元组：`案例与源码-2-LangChain框架/04-prompt/chat_prompt_template/parameter/ChatPromptTemplate_TupleParam.ts`  
字典：`案例与源码-2-LangChain框架/04-prompt/chat_prompt_template/parameter/ChatPromptTemplate_DictParam.ts`  
Message 类：`案例与源码-2-LangChain框架/04-prompt/chat_prompt_template/parameter/ChatPromptTemplate_MessageParam.ts`

[ChatPromptTemplate_TupleParam.ts](案例与源码-2-LangChain框架/04-prompt/chat_prompt_template/parameter/ChatPromptTemplate_TupleParam.ts ":include :type=code")

[ChatPromptTemplate_DictParam.ts](案例与源码-2-LangChain框架/04-prompt/chat_prompt_template/parameter/ChatPromptTemplate_DictParam.ts ":include :type=code")

[ChatPromptTemplate_MessageParam.ts](案例与源码-2-LangChain框架/04-prompt/chat_prompt_template/parameter/ChatPromptTemplate_MessageParam.ts ":include :type=code")
...
【案例源码】`案例与源码-2-LangChain框架/04-prompt/chat_prompt_template/ChatPromptTemplate_FormatMessages.ts`

[ChatPromptTemplate_FormatMessages.ts](案例与源码-2-LangChain框架/04-prompt/chat_prompt_template/ChatPromptTemplate_FormatMessages.ts ":include :type=code")
...
【案例源码】`案例与源码-2-LangChain框架/04-prompt/chat_prompt_template/ChatPromptTemplate_Constructor.ts`

[ChatPromptTemplate_Constructor.ts](案例与源码-2-LangChain框架/04-prompt/chat_prompt_template/ChatPromptTemplate_Constructor.ts ":include :type=code")
...
【案例源码】  
显式：`案例与源码-2-LangChain框架/04-prompt/chat_prompt_template/placeholder/ChatPromptTemplate_ExplicitPlaceholder.ts`  
隐式：`案例与源码-2-LangChain框架/04-prompt/chat_prompt_template/placeholder/ChatPromptTemplate_ImplicitPlaceholder.ts`

[ChatPromptTemplate_ExplicitPlaceholder.ts](案例与源码-2-LangChain框架/04-prompt/chat_prompt_template/placeholder/ChatPromptTemplate_ExplicitPlaceholder.ts ":include :type=code")

[ChatPromptTemplate_ImplicitPlaceholder.ts](案例与源码-2-LangChain框架/04-prompt/chat_prompt_template/placeholder/ChatPromptTemplate_ImplicitPlaceholder.ts ":include :type=code")
...
【案例源码】  
JSON：`案例与源码-2-LangChain框架/04-prompt/load_external/PromptLoadDemo01.ts`  
YAML：`案例与源码-2-LangChain框架/04-prompt/load_external/PromptLoadDemo02.ts`  
配套文件：`prompt.json`、`prompt.yaml`

[PromptLoadDemo01.ts](案例与源码-2-LangChain框架/04-prompt/load_external/PromptLoadDemo01.ts ":include :type=code")

[PromptLoadDemo02.ts](案例与源码-2-LangChain框架/04-prompt/load_external/PromptLoadDemo02.ts ":include :type=code")
