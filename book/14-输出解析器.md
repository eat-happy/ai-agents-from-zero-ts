...
【案例源码】`cases-langchain/05_parser/StructuredOutput_TypedDict.ts`

[StructuredOutput_TypedDict.py](cases-langchain/05_parser/StructuredOutput_TypedDict.ts ":include :type=code")
...
【案例源码】`cases-langchain/05_parser/AnnotatedTypedDict.ts`

[AnnotatedTypedDict.py](cases-langchain/05_parser/AnnotatedTypedDict.ts ":include :type=code")
...
【案例源码】`cases-langchain/05_parser/AnnotatedPydantic.ts`

[AnnotatedPydantic.py](cases-langchain/05_parser/AnnotatedPydantic.ts ":include :type=code")

这个案例和上一个 `AnnotatedTypedDict.ts` 正好形成对照：
...
【案例源码】`cases-langchain/05_parser/StructuredOutput_Pydantic.ts`

[StructuredOutput_Pydantic.py](cases-langchain/05_parser/StructuredOutput_Pydantic.ts ":include :type=code")
