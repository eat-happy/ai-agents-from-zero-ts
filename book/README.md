...
| **低代码平台**   | Coze（扣子）、Dify                          | 工作流、Agent、知识库、插件、TypeScript / Node.js 调用与本地化部署                             |
...
| 章节名称                  | 内容概要                                                                           |
| ------------------------- | ---------------------------------------------------------------------------------- |
| Coze（扣子）平台          | 界面与功能、插件/知识库/工作流/智能体、TypeScript / Node.js 调用工作流                           |
| 项目 1：商户运营管家      | 行业调研 PPT、爆款视频复刻、营销海报、卖点提炼、评论分析                           |
| Dify AI 平台              | 工作流/Agent/知识库、多案例（投诉分类、调研报告、客服分析、评论分析）、TypeScript / Node.js 调用 |
